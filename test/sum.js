...
describe("NFTMARKET", function () {
  ...
  // console.log(3)
  // console.log(4)
  // await market.connect(buyerAddress).buyNft(1, { value: auctionPrice})
  // console.log(5)
  // await market.connect(buyerAddress).buyNft(2, { value: auctionPrice})
 
  // let items = await market.fetchMarketItems();
  // let myItem = await market.fetchMyNFTs(buyerAddress.address)
  // console.log("items",myItem)
  
  // let gifttx = await market.connect(buyerAddress).sellNft(2);
  // let ttx = await gifttx.wait();
  // console.log("treeeeeeeeeeeeee",ttx)
  });
});