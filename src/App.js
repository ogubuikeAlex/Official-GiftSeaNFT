...
const App = () => {
  ...
  const checkForAuthenticatedEthereumWallet = async () => {
    ...
    if (accounts.length !== 0) {
      console.log(`Authorized Account found: ${accounts}`);
  ...
  const connectWallet = async () => {
    ...
    console.log("This is accounto[", accounts.toString().toLowerCase(), "and adminadress:", adminAddress)    
    if (accounts.toString().toLowerCase() === adminAddress.toLowerCase()) {
